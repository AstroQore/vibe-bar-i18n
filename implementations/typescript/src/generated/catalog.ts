...
export const messages: {
  ...
  "en": {
    ...
    "settings.eink.studio.hint": "Drag to place. Arrow keys nudge one pixel, with Shift eight.",
    ...
    "settings.mistralAIIntro": "The Mistral AI page tracks Mistral Vibe. The Monthly quota comes from your Mistral console session, imported from a browser signed in to console.mistral.ai; the plan name comes from the Vibe CLI's own cache. Token usage comes from Mistral Vibe's local session logs, priced at Mistral's API rates.",
  ...
  "zh-Hans": {
    ...
    "settings.eink.studio.hint": "拖动摆放。方向键移动 1 像素，按住 Shift 为 8 像素。",
    ...
    "settings.eink.tapLink.prompt": "https://example.com",
    "settings.eink.tapLink.remote": "Remote 仪表板",
    ...
    "settings.mistralAIIntro": "Mistral AI 页面追踪 Mistral Vibe。Monthly 额度来自 Mistral 控制台的登录会话，从已登录 console.mistral.ai 的浏览器导入；套餐名来自 Vibe CLI 自己的缓存。token 用量来自 Mistral Vibe 的本地会话日志，成本按 Mistral API 单价折算。",
